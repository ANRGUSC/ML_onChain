...
export interface MLP_2L_3nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
...
export interface MLP_2L_3n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_2L_3n;
  waitForDeployment(): Promise<this>;

  interface: MLP_2L_3nInterface;
