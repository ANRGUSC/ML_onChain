...
export interface MLP_1L_1nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
...
export interface MLP_1L_1n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_1L_1n;
  waitForDeployment(): Promise<this>;

  interface: MLP_1L_1nInterface;
