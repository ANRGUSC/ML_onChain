...
export interface MLP_3L_4n1nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
  ...
  encodeFunctionData(
    functionFragment: "weights_layer3",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface MLP_3L_4n1n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_3L_4n1n;
  waitForDeployment(): Promise<this>;

  interface: MLP_3L_4n1nInterface;
  ...
  weights_layer3: TypedContractMethod<
    [arg0: BigNumberish, arg1: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "weights_layer3"
  ): TypedContractMethod<
    [arg0: BigNumberish, arg1: BigNumberish],
    [bigint],
    "view"
