...
export interface MLP_2L_2nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
...
export interface MLP_2L_2n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_2L_2n;
  waitForDeployment(): Promise<this>;

  interface: MLP_2L_2nInterface;
