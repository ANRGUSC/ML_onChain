...
export interface MLP_2L_4nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
...
export interface MLP_2L_4n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_2L_4n;
  waitForDeployment(): Promise<this>;

  interface: MLP_2L_4nInterface;
