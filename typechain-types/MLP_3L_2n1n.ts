...
export interface MLP_3L_2n1nInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "biases"
      | "classify"
...
export interface MLP_3L_2n1n extends BaseContract {
  connect(runner?: ContractRunner | null): MLP_3L_2n1n;
  waitForDeployment(): Promise<this>;

  interface: MLP_3L_2n1nInterface;
