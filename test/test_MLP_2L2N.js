...
contract("MLP_2L_2n.sol", accounts => {
    ...
    before(async () => {
        instance = await MLP_2L_2n.new(2);
        gas_deployment += await MLP_2L_2n.new.estimateGas(2)
    });
    ...
    it("Upload weights and biases", async () => {
        gas_upload_weightBias = await upload_weightsBiases(instance, fsPromises, 'MLP_2L2.json',2)
    });
