...
contract("MLP_2L_4n.sol", accounts => {
    ...
    before(async () => {
        instance = await MLP_2L_4n.new(2);
        gas_deployment += await MLP_2L_4n.new.estimateGas(2)
    });
    ...
    it("Upload weights and biases", async () => {
        gas_upload_weightBias = await upload_weightsBiases(instance, fsPromises, 'MLP_2L4.json',2)
    });
